...
(defvar ge4 (make-estado :tabuleiro gt4 :pecas-por-colocar '(i z s t l o i z s z o o i)))
(defvar gp4
	(make-problema :estado-inicial (make-estado :tabuleiro gt4 :pecas-por-colocar '(i z s t l o i z s z o o i))			
				   :solucao #'solucao
				   :accoes #'accoes
				   :resultado #'resultado
				   :custo-caminho #'custo-oportunidade))
